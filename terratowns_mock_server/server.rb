...
# will mock having a state or database for this dev server
# by setting a global variable. You would never use a global var
# in prod server. 
$home = {}
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def x_access_code
    return '713fb891-8ea9-4020-95ec-ebe8034ab699'
  end
